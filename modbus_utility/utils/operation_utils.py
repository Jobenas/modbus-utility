...
def save_session(data: dict, session_type: DeviceConfigType = DeviceConfigType.master) -> None:
	"""
...
def load_session(session_type: DeviceConfigType = DeviceConfigType.master) -> dict | None:
	"""
